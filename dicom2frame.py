...
def load_and_split(path):
    ...
    for frame in range(len(input_scan_frames)):
        ...
        nib.save(new_nifti, f'PEXA^12_Retro_CTA_LV+RV4A_0-50-5_frame_{frame}.nii.gz')
load_and_split("/mnt/c/Users/Nadin/OneDrive/Documents/Computational_Biomechanics_Lab/Repos/compbiomechproject/4D_CT/PEXA12_ExVivo_CTA_Tank+RV+LV4_RetroA/PEXA^12_CTA_RV_+_LV_+_T4_RetroA.nii.gz")
